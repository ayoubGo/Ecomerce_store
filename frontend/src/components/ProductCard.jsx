...
const ProductCard = ({product}) => {
    ...
    const handleAddToCart = () => {
        if(!user){
            ...
            // todo : add to card store function
            addToCart(product);
    ...
    return (
        <div className="flex w-full relative flex-col overflow-hidden rounded-lg border border-gray-700 shadow-lg">
            <div className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl group">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-20 opacity-0 group-hover:opacity-20 transition"></div>
            </div>
            ...
            <div className="mt-4 px-5 pb-5">
                ...
                <button 
                    className="flex items-center justify-center rounded-lg bg-emerald-600 px-5 py-2.5 text-center text-sm 
                        font-medium text-white hover:bg-emerald-700 focus:outline-none focus:right-4 focus:ring-emerald-300"
