        ...
        transition={{duration:0.8}}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <label 
                        htmlFor="description"
                        className="text-sm font-medium text-gray-300 block mt-5"
                        >
                            Description
                    </label>
                    <textarea
                ...
                <div className="mt-1 flex items-center">
                    ...
                    <label 
                        ...
                        className="cursor-pointer bg-gray-700 py-2 px-3 border border-gray-600 rounded-md
                            shadow-sm text-sm leading-4 font-medium text-gray-300 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2
                ...
                <button 
                    type="submit"
                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm font-medium text-white bg-emerald-600
                        hover:bg-emerald-700 focus:outline-none focus:ring-offset-2 focus:ring-emerald-500 disabled:opacity-50"
                        disabled={loading}
                >
                    {loading ? 
                    <>
