...
const CartItem = ({item}) => {
    ...
    return (
        <div className="rounded-lg bg-gray-800 border p-4 shadow-sm  border-gray-700 md:p-6">
            <div className="space-y-4 md:flex md:items-center md:justify-between  gap-2 md-gap-6 md:space-y-0">
